//
//  ListadoVinculacionViewController.m
//  BLEController
//
...
@interface ListadoVinculacionViewController ()
...
@implementation ListadoVinculacionViewController
...
{    
    ...
    self.lbDetectDevice.hidden = YES;
    ...
    if (showAlert == YES) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Mensaje"
                                                        message:@"No se encontraron dispositivos cercanos."
                                                       delegate:self
